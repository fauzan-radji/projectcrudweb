        ...
        <div class="nav">
          ...
          <?php if (isset($_SESSION["login"])) : ?>
            <?php if ($rowSession["level"] === "superadmin") : ?>
              <a class="nav-link <?= $addProfileActive; ?>" href="<?= $main_url ?>profil/add-profil">
          ...
          <a class="nav-link <?= $prokerActive; ?>" href="<?= $main_url ?>proker/proker">
            <div class="sb-nav-link-icon"><i class="fa-solid fa-chart-bar"></i></div>
            Program Kerja
          </a>

          <a class="nav-link <?= $eventActive; ?>" href="<?= $main_url ?>event/event">
            <div class="sb-nav-link-icon"><i class="fa-solid fa-chart-bar"></i></div>
            Event
          </a>

          <a class="nav-link <?= $galeriActive; ?>" href="<?= $main_url ?>galeri/galeri">
            <div class="sb-nav-link-icon"><i class="fa-solid fa-images"></i></div>
            Galeri
          </a>

          <a class="nav-link <?= $beritaActive; ?>" href="<?= $main_url ?>berita/berita">
          ...
          <?php if (isset($_SESSION["login"])) : ?>
            <?php if ($rowSession["level"] === "superadmin") : ?>
              <a class="nav-link <?= $userActive; ?>" href="<?= $main_url ?>user/add-user">
          ...
          <a class="nav-link <?= $mapsActive; ?>" href="<?= $main_url ?>petaweb/maps">
